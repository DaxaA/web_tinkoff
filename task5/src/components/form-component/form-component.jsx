    ...
    return (
        <div className="form-wrapper">
            ...
            <Form form={form} layout="vertical" onFinish={onFinish}>
                ...
                <Form.Item label={<h2>Year</h2>} required tooltip="Required field" style={{ fontSize: '20px' }}>
                    <Input
                        id="year"
                ...
                <Form.Item label={<h2>Actors</h2>} required tooltip="Required field" style={{ fontSize: '20px' }}>
                    <Input
                        id="actors"
                        placeholder="Enter thorugh ;"
                        style={{ width: '300px', backgroundColor: '#ecf1f7' }}
                        onChange={onChange}
                    />
                </Form.Item>
